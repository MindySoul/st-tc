    ...
    <section className="bg-background py-16 lg:py-24">
      <div className="container max-w-4xl text-center reveal">
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          ...
          <Link href="/contato#orcamento" className="border-2 border-primary text-primary font-bold px-7 py-3 rounded-md uppercase text-sm btn-press hover:bg-primary hover:text-primary-foreground transition">Falar com especialista</Link>
        </div>
      </div>
    </section>
          ...
          {sistemas.map((s, i) => {
            ...
            return (
              <article key={i} className="bg-background border border-border rounded-xl p-7 relative card-hover overflow-hidden">
                ...
                <Link href="/contato#orcamento" className="block text-center bg-primary text-primary-foreground font-bold py-3 rounded-md uppercase text-xs btn-press hover:bg-primary-dark">{s.cta}</Link>
              </article>
            );
          })}
        </div>
            ...
            return (
              <article key={s.tipo} className={`grid lg:grid-cols-2 gap-10 items-center reveal ${i%2 ? 'lg:[&>*:first-child]:order-2' : ''}`}>
                ...
                <div>
                  ...
                  <Link href="/contato#orcamento" className="inline-block bg-primary text-primary-foreground font-bold px-6 py-3 rounded-md uppercase text-xs btn-press hover:bg-primary-dark">
          ...
          {extras.map(e => {
            ...
            return (
              <article key={e.h} className="bg-background border border-border rounded-xl p-6 card-hover">
                ...
                <Link href="/contato#orcamento" className="inline-block border border-primary text-primary font-semibold px-5 py-2 rounded-md text-xs uppercase btn-press hover:bg-primary-soft">
                  Quero saber mais
                </Link>
              </article>
            );
    ...
    <section className="bg-primary text-primary-foreground py-16 lg:py-24">
      <div className="container">
        ...
        <div className="text-center mt-10">
          <Link href="/contato#orcamento" className="inline-block bg-background text-primary font-bold px-7 py-3.5 rounded-md uppercase text-sm btn-press hover:bg-primary-soft">
