...
const Conteudo = () => {
  ...
  return (
    <>
      ...
      {/* scroll-mt compensa a navbar fixa (h-16, lg:h-20) — sem isso a ancora
          para com o titulo escondido atras dela. */}
      <section id="orcamento" className="bg-background py-16 lg:py-20 scroll-mt-16 lg:scroll-mt-20">
