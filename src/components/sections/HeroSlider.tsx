...
const slides = [
  ...
  { img: heroCom, badge: 'ENERGIA SOLAR COMERCIAL',
    ...
    cta1: { label: 'Quero orçamento comercial →', to: '/contato#orcamento' } },
  { img: heroRur, badge: 'ENERGIA SOLAR RURAL',
    ...
    cta1: { label: 'Quero orçamento rural →', to: '/contato#orcamento' } },
  { img: heroInd, badge: 'ENERGIA SOLAR INDUSTRIAL',
    ...
    cta1: { label: 'Quero orçamento industrial →', to: '/contato#orcamento' } },
];
